(function () {
  ...
  QUnit.test('fabric.util.copyCanvasElement', function (assert) {
    ...
    c.width = 10;
    c.height = 20;
    c.getContext('2d', { willReadFrequently: true }).fillStyle = 'red';
    c.getContext('2d', { willReadFrequently: true }).fillRect(0, 0, 10, 10);
    ...
    var data = b.getContext('2d', { willReadFrequently: true }).getImageData(1, 1, 1, 1).data;
